...
/*const handleSubmit = async (e) => {
  ...
  if (userConfirmed) {
    ...
    try {
      const response = await fetch('https://backend-ac-production.up.railway.app/transacciongg', requestOptions);
...
const RegistrarGestorGestor = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const response = await fetch('https://backend-ac-production.up.railway.app/transacciones/gg');
      if (response.ok) {
  ...
  const guardarEdicion = async () => {
    ...
    try {
      const response = await fetch(`https://backend-ac-production.up.railway.app/transacciones/gg/${editandoId}`, requestOptions);
  ...
  const eliminarRegistro = async (id) => {
    try {
      const response = await fetch(`https://backend-ac-production.up.railway.app/transacciones/gg/${id}`, {
        method: 'DELETE',
      });
